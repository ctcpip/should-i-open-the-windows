...
const scenarios = [
  ...
  },
  {
    ...
    expectVerdict: ['good', 'marginal', 'not-worth-it'],
  },
  {
  ...
  },
  {
    ...
    expectNeeds: ['cool'],
    expectVerdict: ['not-worth-it', 'likely-worse', 'marginal', 'avoid'],
  },
  {
  ...
  {
    name: 'Hot inside cracked windows -- limited net cooling despite cold outdoor',
    input: {
      indoorTempF: 82,
      outdoorTempF: 68,
      indoorRh: 55,
    ...
    expectNeeds: ['cool', 'dehumidify'],
    expectVerdict: ['marginal', 'not-worth-it', 'likely-worse', 'avoid'],
  },
  {
    name: 'Windy when outdoor is 1°F warmer while cooling -- breeze hurts',
    input: {
      indoorTempF: 78,
      outdoorTempF: 79,
      indoorRh: 50,
